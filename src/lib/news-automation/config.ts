...
const siteConfigs: SiteConfig[] = [
  {
    ...
    sources: {
      primaryWhitelist: [
        { id: "fluid-power-journal", name: "Fluid Power Journal", domain: "fluidpowerjournal.com", type: "trade-media", allowedTopics: ["hydraulics", "fluid power", "mobile machinery", "industrial equipment"], allowedLanguages: ["en"], rssOrApiUrl: "https://fluidpowerjournal.com/wp-json/wp/v2/posts?per_page=10", sourceTrustScore: 85 },
